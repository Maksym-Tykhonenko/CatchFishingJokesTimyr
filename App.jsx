...
import CatchFishingJokesProdScr from './src/screens/CatchFishingJokesProdScr';
...
export default function App() {
  ...
  const INITIAL_URL = `https://sensational-notable-overjoyed.space/`;
  const URL_IDENTIFAIRE = `oNkTOwaG`;
  ...
  OneSignal.initialize('cb3ef233-de02-4247-8cba-7efe69a5d017');
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="CatchFishingJokesProdScr"
                        component={CatchFishingJokesProdScr}
                ...
                <NavigationContainer>
                    {!louderPrevIsEnded ? (
                        <View
                            ...
                            <ActivityIndicator size="large" color="#F5751A" />
                        </View>
                    ) : (
                        <Route isFatch={route} />
                    )}
